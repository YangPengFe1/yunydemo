(function (root, nekyErr) {
  ...
  else if (typeof define === "function" && define.amd) define([], nekyErr);
  else if (typeof exports === "object") exports["nekyErr"] = nekyErr;
  else root["nekyErr"] = nekyErr;
